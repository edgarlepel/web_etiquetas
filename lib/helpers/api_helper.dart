...
class ApiHelper {
  static Future<Response2> getEtiqueta(String fecini, String fecfin) async {
    ...
    try {
      ...
      return Response2(
          isSuccess: false, message: 'Sin internet  o falla de servidor');
    } on HttpException {
      client.close;
      //throw ("No se encontro esa peticion");
      return Response2(
          isSuccess: false, message: 'No se encontro esa peticion');
    } on FormatException {
      client.close;
      //throw ("Formato erroneo ");
      return Response2(isSuccess: false, message: 'Formato erroneo');
    }
